   ...
   <main role="main">
     <section class="mainSectionContainer">
        <div class="header-top">
           <h4>Messages</h4>
           <a href="<?php echo url_for('messages/compose'); ?>" class="m-icon-wrapper">
     ...
     <aside role="complementary" class="right-msg">
        <div class="no-msg-container">
            <div class="n-msg-wrapper">
                ...
                <a href="<?php echo url_for("messages/compose") ?>" class="n-msg" role="button" data-focusable="true">New message</a>
            </div>
        </div>
     </aside>
   </main>
