...
<section class="wrapper">
    <header role="heading" class="h-header-wr">
        <div class="h-wrapper">
            <div class="h-wrapper-nav-link">
                ...
                <nav role="navigation" class="nav" id="nav">
                    ...
                    <a href="<?php echo url_for('i/notifications'); ?>" class="link">
            ...
            <footer class="w-header-footer">
                <div class="w-header-container" aria-label="<?php echo $user->firstName.' '.$user->lastName; ?>">
                    <div class="w-header-pr">
                        <img src="<?php echo url_for($user->profileImage); ?>" width="39px;" height="39px;" alt="<?php echo $user->firstName.' '.$user->lastName; ?>">
                    </div>
