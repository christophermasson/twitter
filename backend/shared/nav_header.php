<header role="banner" class="h-heading-wr">
      <div class="h-wrapper">
        <div class="h-wrapper-nav-link">
           ...
           <nav aria-label="Primary" role="navigation" class="nav" id="nav">
              <a href="<?php echo url_for('home'); ?>" class="link">
                 <?php if(strpos($_SERVER['REQUEST_URI'],'/home')){ ?>
                 <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24"><g><path d="M22.58 7.35L12.475 1.897c-.297-.16-.654-.16-.95 0L1.425 7.35c-.486.264-.667.87-.405 1.356.18.335.525.525.88.525.16 0 .324-.038.475-.12l.734-.396 1.59 11.25c.216 1.214 1.31 2.062 2.66 2.062h9.282c1.35 0 2.444-.848 2.662-2.088l1.588-11.225.737.398c.485.263 1.092.082 1.354-.404.263-.486.08-1.093-.404-1.355zM12 15.435c-1.795 0-3.25-1.455-3.25-3.25s1.455-3.25 3.25-3.25 3.25 1.455 3.25 3.25-1.455 3.25-3.25 3.25z"/></g></svg>
                 <?php  }else { ?>
              ...
              <a href="<?php echo url_for('messages'); ?>" class="link">
                <?php if(strpos($_SERVER['REQUEST_URI'],'messages')){ ?>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24"><g><path d="M11.55 12.082c.273.182.627.182.9 0L22 5.716V5.5c0-1.24-1.01-2.25-2.25-2.25H4.25C3.01 3.25 2 4.26 2 5.5v.197l9.55 6.385z"/><path d="M13.26 13.295c-.383.255-.82.382-1.26.382s-.877-.127-1.26-.383L2 7.452v11.67c0 1.24 1.01 2.25 2.25 2.25h15.5c1.24 0 2.25-1.01 2.25-2.25V7.47l-8.74 5.823z"/></g></svg>
                  <?php  }else { ?> 
        ...
        <footer class="w-header-footer" aria-label="Account menu" role="button" data-focusable="true" tabindex="0">
